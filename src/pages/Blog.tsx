...
const blogPosts = [
    ...
    
    {
        ...
        description: "Sapa, một thị trấn vùng cao Tây Bắc, luôn là điểm đến mơ ước của những tâm hồn yêu thiên nhiên và muốn khám phá .",
        date: "05/07/2025",
        category: "Khám phá"
    },
    {
    ...
    },
    {
        ...
        description: "Thành phố biển xinh đẹp với làn nước trong xanh và cát trắng mịn.",
        date: "01/07/2025",
        category: "Biển đảo"
    },
    {
        ...
        description: "Địa chỉ Viện Hải Dương Học Nha Trang là vấn đề được rất nhiều người quan tâm và thắc mắc. Nơi đây là một trong những điểm đến thú vị cho những ai yêu thích những sinh vật biển độc đáo.",
        date: "01/04/2024",
        category: "Khám "
    },
...
// Thêm dữ liệu popularTags bị thiếu
const popularTags = [
    { name: "Biển đảo", count: 4},
    { name: "Văn hóa", count: 2 },
    { name: "Khám phá", count: 3 },
];
...
const Blog = () => {
    ...
    const filteredPosts = latestPosts.filter((post) => {
        ...
        const matchesCategory = selectedCategory === "Tất cả chủ đề" || post.category === selectedCategory;
                        ...
                        {currentPosts.length > 0 ? (
                            ...
                            <div className="text-center py-12 bg-white bg-opacity-90 backdrop-blur-sm rounded-xl">
                                <svg className="w-16 h-16 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.29-1.044-5.709-2.566M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <h3 className="text-xl font-semibold text-gray-600 mb-2">Không tìm thấy bài viết</h3>
                                <p className="text-gray-500">Thử thay đổi từ khóa tìm kiếm hoặc chọn chủ đề khác</p>
                            </div>
                        )}
                                    ...
                                    <Link to={`/blog/${post.id}`} key={post.id} className="block group">
                                        <div className="flex gap-3 hover:bg-gray-50 p-3 rounded-lg transition-colors">
                                            <img 
                                                ...
                                                onError={(e) => {
                                                    e.currentTarget.src = "https://via.placeholder.com/64x64?text=Ảnh";
                                                }}
                                            />
