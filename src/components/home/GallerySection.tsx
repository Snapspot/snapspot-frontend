...
const GallerySection = () => {
    ...
    return (
        <>
            <section
                className="relative isolate w-full overflow-hidden py-8 sm:py-12 md:py-16 lg:py-20"
            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 sm:px-6 md:px-8">
                    ...
                    <div className="w-full flex items-center justify-center px-2 sm:px-4 mb-6 sm:mb-8 md:mb-12">
                        ...
                        <h2 id="gallery-heading" className="px-2 sm:px-4 text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#215858] whitespace-nowrap text-center">
